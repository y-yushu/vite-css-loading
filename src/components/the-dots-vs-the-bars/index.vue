...
<template>
  <h1>条形款-3</h1>
  <div class="grid">
    <div class="dots-bars-1" @click="dots_bars_1()" />
    <div class="dots-bars-2" @click="dots_bars_2()" />
    <div class="dots-bars-3" @click="dots_bars_3()" />
    <div class="dots-bars-4" @click="dots_bars_4()" />
    <div class="dots-bars-5" @click="dots_bars_5()" />
    <div class="dots-bars-6" @click="dots_bars_6()" />
    <div class="dots-bars-7" @click="dots_bars_7()" />
    <div class="dots-bars-8" @click="dots_bars_8()" />
    <div class="dots-bars-9" @click="dots_bars_9()" />
    <div class="dots-bars-10" @click="dots_bars_10()" />
  </div>
</template>
