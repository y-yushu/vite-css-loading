...
<template>
  <h1>飞镖样式款</h1>
  <div class="grid">
    <div class="shuriken-1" @click="dome1()" />
    <div class="shuriken-2" @click="dome2()" />
    <div class="shuriken-3" @click="dome3()" />
    <div class="shuriken-4" @click="dome4()" />
    <div class="shuriken-5" @click="dome5()" />
    <div class="shuriken-6" @click="dome6()" />
    <div class="shuriken-7" @click="dome7()" />
    <div class="shuriken-8" @click="dome8()" />
    <div class="shuriken-9" @click="dome9()" />
    <div class="shuriken-10" @click="dome0()" />
  </div>
</template>
