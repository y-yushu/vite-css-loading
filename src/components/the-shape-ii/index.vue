...
<template>
  <h1>几何变形-2</h1>
  <div class="grid">
    <div class="shapes-1" @click="dome1()" />
    <div class="shapes-2" @click="dome2()" />
    <div class="shapes-3" @click="dome3()" />
    <div class="shapes-4" @click="dome4()" />
    <div class="shapes-5" @click="dome5()" />
    <div class="shapes-6" @click="dome6()" />
    <div class="shapes-7" @click="dome7()" />
    <div class="shapes-8" @click="dome8()" />
    <div class="shapes-9" @click="dome9()" />
    <div class="shapes-10" @click="dome0()" />
  </div>
</template>
