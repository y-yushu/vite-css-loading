...
<template>
  <h1>食物样式款</h1>
  <div class="grid">
    <div class="hungry-1" @click="hubgry_1()" />
    <div class="hungry-2" @click="hubgry_2()" />
    <div class="hungry-3" @click="hubgry_3()" />
    <div class="hungry-4" @click="hubgry_4()" />
    <div class="hungry-5" @click="hubgry_5()" />
    <div class="hungry-6" @click="hubgry_6()" />
    <div class="hungry-7" @click="hubgry_7()" />
    <div class="hungry-8" @click="hubgry_8()" />
  </div>
</template>
