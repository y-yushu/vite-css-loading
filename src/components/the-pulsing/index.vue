...
<template>
  <h1>脉动款</h1>
  <div class="grid">
    <div class="pulsing-1" @click="dome1()" />
    <div class="pulsing-2" @click="dome2()" />
    <div class="pulsing-3" @click="dome3()" />
    <div class="pulsing-4" @click="dome4()" />
    <div class="pulsing-5" @click="dome5()" />
    <div class="pulsing-6" @click="dome6()" />
    <div class="pulsing-7" @click="dome7()" />
    <div class="pulsing-8" @click="dome8()" />
    <div class="pulsing-9" @click="dome9()" />
    <div class="pulsing-10" @click="dome0()" data-c="💯" />
  </div>
</template>
